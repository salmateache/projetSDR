...
public class Rendezvous implements Serializable {
    ...
    public Rendezvous(Integer id, Date dateRdv, Date heureRdv) {
        this.id = id;
    ...
    public Medecins getMedecinId() {
        return medecinId;
    }

    public void setMedecinId(Medecins medecinId) {
